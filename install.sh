...
print(f'Try: "blockrun generate a sunset" → DALL-E image')
print(f'Try: "blockrun check @elonmusk" → Live Twitter/X')
print(f'Try: "blockrun GPT review this code" → GPT-5/Grok')
if bal == 0:
    print(f'Fund: Send USDC (Base) to {addr}')
print('=' * 50)
import sys
sys.stdout.flush()
PYEOF
